...
func NewBaseElem() *BaseElem {
	return &BaseElem{}
}

func (p *BaseElem) InitDefault() {
}

var BaseElem_A_DEFAULT int32

func (p *BaseElem) GetA() (v int32) {
	if !p.IsSetA() {
		return BaseElem_A_DEFAULT
	}
	return *p.A
}
func (p *BaseElem) SetA(val *int32) {
	p.A = val
}

var fieldIDToName_BaseElem = map[int16]string{
	1: "a",
}

func (p *BaseElem) IsSetA() bool {
	return p.A != nil
}

func (p *BaseElem) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_BaseElem[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *BaseElem) ReadField1(iprot thrift.TProtocol) error {
...
func (p *BaseElem) Write(oprot thrift.TProtocol) (err error) {

	var fieldId int16
	if err = oprot.WriteStructBegin("BaseElem"); err != nil {
		goto WriteStructBeginError
	}
	if p != nil {
		if err = p.writeField1(oprot); err != nil {
...
func (p *BaseElem) writeField1(oprot thrift.TProtocol) (err error) {
	if p.IsSetA() {
...
func (p *BaseElem) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("BaseElem(%+v)", *p)

}

func (p *BaseElem) DeepEqual(ano *BaseElem) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
...
func (p *BaseElem) Field1DeepEqual(src *int32) bool {
